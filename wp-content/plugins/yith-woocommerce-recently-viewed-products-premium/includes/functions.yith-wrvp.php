				...
				<fieldset>
					<div id="<?php echo esc_attr( $field ); ?>-container" class="plugin-option">
						<input type="text" name="<?php echo esc_attr( $field ); ?>"
						       id="<?php echo esc_attr( $field ); ?>" value="<?php echo $email->get_option( $key ); ?>"
						       class="upload_img_url" style="width: 25em;"/>
						<input type="button" value="<?php _e( 'Upload', 'yith-plugin-fw' ) ?>"
				...
				<fieldset>
					<div id="<?php echo esc_attr( $field ); ?>-container" class="plugin-option">
                        ...
                        <?php foreach( $data['options'] as $key => $value ) : ?>
                            <li>
                                <label>
                                    <input type="radio" id="<?php echo esc_attr( $field ); ?>" name="<?php echo esc_attr( $field ); ?>"
